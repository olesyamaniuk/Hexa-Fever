document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".b-navigation-list");
  const headerRef = document.querySelector(".b-header");
  const navigationRef = document.querySelector(".b-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".b-toggle-button img");
